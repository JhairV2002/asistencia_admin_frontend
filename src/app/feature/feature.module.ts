...
import { CategoriasComboboxComponent } from './categoria/list/categoria-list.component';
...
import { ComboboxComponent } from './categoria/combobox/combobox.component';
@NgModule({
  declarations: [
